...
{$endif}
    ...
    if @Plan404 = nil then
    begin
      MessageDlg(rsCouldNotLoad + lib404 + crlf + rsPleaseTryToR,
        mtError, [mbAbort], 0);
      Halt;
    end;
    step := 'Load cdcwcs';
...
{$endif}
  ...
  catalog.cfgshr.NebMagFilter[5] := 15;
  catalog.cfgshr.NebMagFilter[6] := 13;
  catalog.cfgshr.NebMagFilter[7] := 10.5;
  ...
  catalog.cfgshr.NebSizeFilter[4] := 1;
  catalog.cfgshr.NebSizeFilter[5] := 2;
  catalog.cfgshr.NebSizeFilter[6] := 3;
  catalog.cfgshr.NebSizeFilter[7] := 6;
...
begin
  ...
  PlanetInfo.Caption := '&' + rsSolarSystemI + Ellipsis;
