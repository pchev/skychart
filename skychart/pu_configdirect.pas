...
begin
  ...
  f_config_system1.parent:=ScrollBox1 ;
  f_config_time1.parent:=ScrollBox2 ;
  f_config_observatory1.parent:=ScrollBox3 ;
  f_config_chart1.parent:=ScrollBox4 ;
  f_config_catalog1.parent:=ScrollBox5 ;
  f_config_solsys1.parent:=ScrollBox6 ;
  f_config_display1.parent:=ScrollBox7 ;
  f_config_pictures1.parent:=ScrollBox8 ;
  f_config_internet1.parent:=ScrollBox9 ;
  f_config_calendar1.parent:=ScrollBox10 ;
