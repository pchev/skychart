...
procedure Tf_configsystem.FormClose(Sender: TObject; var CloseAction: TCloseAction);
begin
...
begin
  if assigned(f_config_system1.onApplyConfig) then
    f_config_system1.onApplyConfig(f_config_system1);
end;
