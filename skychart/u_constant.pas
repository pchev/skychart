...
const cdcversion = 'Version 3.7-svn';
      ...
      minjddt=260423.5;  // -4000    // limit for DeltaT calculation, no JPL ephemeris after this date
...
//  End of deep-sky objects colour
      ...
      pla : array[1..32] of string[20] = ('Mercury ','Venus   ','*       ','Mars    ','Jupiter ',
      ...
      NebLabel : Tlabellst =('RA','DEC','Id','NebTyp','m','sbr','Dim','Dim','Unit','pa','rv','class','desc','','','Str1','Str2','Str3','Str4','Str5','Str6','Str7','Str8','Str9','Str10','Num1','Num2','Num3','Num4','Num5','Num6','Num7','Num8','Num9','Num10');
