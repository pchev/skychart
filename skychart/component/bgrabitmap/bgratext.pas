...
type
  ...
  public
    ...
    procedure TextOutAngle(ADest: TBGRACustomBitmap; x, y: single; orientation: integer; sUTF8: string; c: TBGRAPixel; align: TAlignment); override;
    procedure TextOutAngle(ADest: TBGRACustomBitmap; x, y: single; orientation: integer; sUTF8: string; texture: IBGRAScanner; align: TAlignment); override;
...
begin
  UpdateFont;
  BGRAText.BGRATextOutAngle(ADest,FFont,FontQuality,x,y,orientation,sUTF8,c,nil,align);
end;
...
begin
  UpdateFont;
  BGRAText.BGRATextOutAngle(ADest,FFont,FontQuality,x,y,orientation,sUTF8,BGRAPixelTransparent,texture,align);
end;
