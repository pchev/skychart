...
if night then begin
   ...
   SetFormNightVision(self, true);
   SetFormNightVision(f_calendar, true);
   SetFormNightVision(f_detail, true);
   SetFormNightVision(f_search, true);
   SetFormNightVision(f_zoom, true);
   SetFormNightVision(f_info, true);
   SetFormNightVision(f_position, true);
   SetFormNightVision(f_directory, true);
   SetFormNightVision(f_getdss, true);
   SetFormNightVision(f_printsetup, true);
   if f_config<>nil then begin
      SetFormNightVision(f_config, true);
   end;
 end else begin
   ...
   SetFormNightVision(self, false);
   SetFormNightVision(f_calendar, false);
   SetFormNightVision(f_detail, false);
   SetFormNightVision(f_search, false);
   SetFormNightVision(f_zoom, false);
   SetFormNightVision(f_info, false);
   SetFormNightVision(f_position, false);
   SetFormNightVision(f_directory, false);
   SetFormNightVision(f_getdss, false);
   SetFormNightVision(f_printsetup, false);
   if f_config<>nil then begin
      SetFormNightVision(f_config, false);
   end;
end;
SetTheme;
end;
