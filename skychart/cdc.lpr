...
uses
  ...
  cdccatalog, Printer4Lazarus, pascalscript, downldialog, synapse, pu_catgen,
  pu_obslist, pu_catgenadv, pu_progressbar, mrecsort, pu_addlabel, pu_print,
  u_translation, pu_splash, pu_about, cu_tz, uniqueinstance_package, u_help,
  LCLProc, pu_clock, u_unzip, cu_tcpserver, pu_indiclient, u_satellite, pu_main,
  pu_observatory_db, pu_lx200client, cu_lx200protocol, cu_serial,
  pu_encoderclient, cu_taki, cu_encoderprotocol, pu_ascomclient, uDE,
  pu_voconfig, pr_vodetail, bgrabitmappack, lazvo, multiframepackage,
  fu_config_time, fu_config_catalog, fu_config_chart, fu_config_display,
  ...
  u_scriptsocket, pu_scriptconfig, pu_tour, UScaleDPI, u_ccdconfig, u_orbits;
