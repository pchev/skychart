...
east:=rsEast;
west:=rsWest;
EcliPanel.Hint:='http://sunearth.gsfc.nasa.gov/eclipse/eclipse.html';
...
if c.ObsLongitude>0 then d:=west else d:=east;
...
x:=abs(c.TimeZone);
if c.TimeZone<0 then d:=west else d:=east;
