...
TreeView1.items[17].text:='4- '+rsOtherSoftwar;
TreeView1.items[18].text:='5- '+rsObsolete;
TreeView1.items[19].text:='5- '+rsSolarSystem;
TreeView1.items[20].text:='1- '+rsSolarSystem;
TreeView1.items[21].text:='2- '+rsPlanet;
TreeView1.items[22].text:='3- '+rsComet;
TreeView1.items[23].text:='4- '+rsAsteroid;
TreeView1.items[24].text:='6- '+rsDisplay;
TreeView1.items[25].text:='1- '+rsDisplay;
TreeView1.items[26].text:='2- '+rsDisplayColou;
TreeView1.items[27].text:='3- '+rsDeepSkyObjec;
TreeView1.items[28].text:='4- '+rsSkyBackgroun;
TreeView1.items[29].text:='5- '+rsLines;
TreeView1.items[30].text:='6- '+rsLabels;
TreeView1.items[31].text:='7- '+rsFonts;
TreeView1.items[32].text:='8- '+rsFinderCircle;
TreeView1.items[33].text:='9- '+rsFinderRectan;
TreeView1.items[34].text:='7- '+rsPictures;
TreeView1.items[35].text:='1- '+rsObject;
TreeView1.items[36].text:='2- '+rsBackground;
TreeView1.items[37].text:='3- '+rsDSSRealSky;
TreeView1.items[38].text:='8- '+rsSystem;
TreeView1.items[39].text:='1- '+rsSystem;
TreeView1.items[40].text:='2- '+rsServer;
TreeView1.items[41].text:='3- '+rsTelescope;
TreeView1.items[42].text:='4- '+rsLanguage2;
TreeView1.items[43].text:='9- '+rsInternet;
TreeView1.items[44].text:='1- '+rsProxy;
TreeView1.items[45].text:='2- '+rsOrbitalEleme;
TreeView1.items[46].text:='3- '+rsOnlineDSSPic;
