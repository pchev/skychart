...
install -v -m 644 system_integration/Linux/skychart-data-dso/share/metainfo/skychart-data-dso.metainfo.xml $destdir/share/metainfo/skychart-data-dso.metainfo.xml
